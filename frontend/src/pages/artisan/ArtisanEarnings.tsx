// pages/artisan/ArtisanEarnings.tsx
  ...
  return (
    <div className="min-h-screen bg-secondary py-10 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-gray-600 mb-8">Track your craft sales earnings and payouts</p>
          ...
          <div className="flex flex-wrap gap-4 items-end">
            ...
            <div className="flex-1">
              ...
              <select className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-accent">
                <option>SBI Bank - XXXXX1234</option>
                <option>ICICI Bank - XXXXX5678</option>
